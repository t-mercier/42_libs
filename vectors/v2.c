...
/*   Updated: 2022/11/29 13:55:32 by asaijers      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void *ft_vector_pop(t_vector *v) { return (v->data + --v->len * v->esz); }
...
t_vector *ft_vector_copy(t_vector *v) {
  t_vector *n = ft_vector_create(v->esz);
...
void *ft_vector_get(t_vector *v, int i) { return v->data + i * v->esz; }